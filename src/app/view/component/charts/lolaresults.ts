...
@Component({
    selector: 'app-lolaresults-bar-chart',
    styles: [`
        chart {
            display: block;
        }
...
export class LolaResultsBarChartComponent {
    options: Object;
    chart: any;
    ...
    constructor() {
        this.options = {
            ...
            title: {
                text: 'Overlap Enrichment Results'
            },
            xAxis: {
                categories: []
            },
    ...
    /*    changeTitle(newTitle: string): void {
        ...
        changeYAxisTitle(newTitle: string): void {
            this.chart.yAxis[0]['setTitle']({text: newTitle});
        }*/
    resize(): void {
        this.chart['reflow']()
    }
